...
fn = 'detectron2 files\retina\results_yolocat_test1.json'
% fn = 'detectron2 files\mask\results_retinacat_test1.json'
% fn = 'detectron2 files\retina\results_train_aug3_retinaR101.json'
% fn = 'detectron2 files\retina\results_retina_trainedBy_aug3yolo_train_aug4.json'
s = fileread(fn);
R = jsondecode(s)
...
imageDir2 = 'ResultOfDetection\Retina_test1';
% imageDir2 = 'ResultOfDetection\RetinaR101_train';
% imageDir2 = 'ResultOfDetection\YoloRetinaR101_train_aug4';
...
% 
% 
% save  BoxScore_test1_Retina     ap results  Scores BBoxes
% save  BoxScore_trainaug3_Retina     ap results  Scores BBoxes
